...
{
    DisplayRenderingPolicySfml::DisplayRenderingPolicySfml(PixelArray& pixels) :
        pixels_(pixels),
        pixelQuads_(pixels_)
    {
    }

    void DisplayRenderingPolicySfml::Begin() {
    ...
    void DisplayRenderingPolicySfml::Update() 
    {
    ...
    DisplayRenderingPolicySfml::PixelQuads::PixelQuads(const PixelArray& pixels) :
        pixels_(pixels)
    {
    ...
    void DisplayRenderingPolicySfml::PixelQuads::Update() 
    {
    ...
    void DisplayRenderingPolicySfml::PixelQuads::draw(sf::RenderTarget& target, sf::RenderStates states) const
    {
