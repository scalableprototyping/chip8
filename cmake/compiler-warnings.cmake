macro(target_add_compiler_warnigs TARGET_NAME_ARG)

    if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
        execute_process(COMMAND echo "-- Setting Clang warnings")

    elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
        if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "8.0.0")
            message(FATAL_ERROR "Insufficient gcc version")
        endif()
        execute_process(COMMAND echo "-- Setting GCC warnings")
    ...
    elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")
        execute_process(COMMAND echo "-- Setting Intel C++ warnings")

    elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
        execute_process(COMMAND echo "-- Setting Visual Studio C++ warnings")

    endif()

    target_compile_options(${MAIN_TARGET} PRIVATE ${COMPILE_WARNINGS})

endmacro(target_add_compiler_warnigs)
