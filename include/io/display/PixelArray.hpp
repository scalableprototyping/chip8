...
namespace chip8::io::display
{
    class PixelArray
    {
        public:
            ...
            PixelValue_t& at(std::size_t col, std::size_t row);
            const PixelValue_t& at(std::size_t col, std::size_t row) const;

            Iterator_t iterator_at(std::size_t col, std::size_t row);
            ConstIterator_t iterator_at(std::size_t col, std::size_t row) const;
        ...
        private:
            Array_t pixels_;
            inline void throwIfOutOfRange(std::size_t col, std::size_t row) const;
    };
}
